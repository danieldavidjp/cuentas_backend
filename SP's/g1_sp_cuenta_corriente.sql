USE cobis
GO
ALTER PROCEDURE g1_sp_cuenta_corriente (
	@s_ssn			int = NULL,
	@s_user			login = NULL,
	@s_sesn			int = NULL,
...
AS
	...
	SELECT @w_result = cc_banco FROM g1_cuenta_corriente WHERE cc_banco = @i_numero_cuenta;
		IF @w_result IS NOT NULL
		BEGIN
			exec cobis..sp_cerror
						@t_debug  = @t_debug,
                        @t_file   = @t_file,
                        @t_from  = @w_sp_name,
                        @i_num   = 1852 -- La cuenta ya existe
                return 1
		END
